...
public class IF_ICMPGT extends gov.nasa.jpf.jvm.bytecode.IF_ICMPGT{
	...
	public Instruction execute (ThreadInfo ti) {
		...
		gov.nasa.jpf.symbc.numeric.IntegerExpression sym_v1 = (gov.nasa.jpf.symbc.numeric.IntegerExpression) sf.getOperandAttr(1);
		gov.nasa.jpf.symbc.numeric.IntegerExpression sym_v2 = (gov.nasa.jpf.symbc.numeric.IntegerExpression) sf.getOperandAttr(0);
		...
		if ((sym_v1 == null) && (sym_v2 == null)) { // both conditions are concrete
			...
			Instruction nxtInstr = IFInstrSymbHelper.getNextInstructionAndSetPCChoice(ti, 
																					  ...
																					  sym_v1,
																					  sym_v2,
																					  gov.nasa.jpf.symbc.numeric.Comparator.GT,
																					  gov.nasa.jpf.symbc.numeric.Comparator.LE);
